...
class ReportCommand extends MscReportCommand
{
    ...
    protected static $defaultName = 'msc:performance-vessel-report';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($arrShipCollection as $objShip) {
            $this->logForShip($objShip, 'info', 'erstelle Vessel-Performance-Report (:from_date-:to_date)', array(
            ...
            $strCommand = strtr('nohup :interpreter :script --from=:intFromTs --to=:intToTs --period=:period --ship_id=:ship_id :dryRun --http_host=:http_host &', array(
                ...
                ':script' => $this->objContainer->get('kernel')->getProjectDir() . '/bin/console msc:performance-vessel-report-worker',
