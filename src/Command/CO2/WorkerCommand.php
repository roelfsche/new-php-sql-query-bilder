...
use App\Service\Maridis\Pdf\Report\CO2;
...
class WorkerCommand extends ReportCommand
{
    ...
    protected static $defaultName = 'msc:co2-report-worker';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $objPdfReport = new CO2($this->objContainer, $objShip, $intFromTs, $intToTs);
        ...
        // $objPdfReport->Output('/tmp/co2.pdf', 'F');
